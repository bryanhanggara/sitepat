                ...
                <div class="mb-6">
                    <label class="flex items-start text-white text-opacity-80">
                        ...
                        <span class="ml-2 text-sm">
                            I agree to the 
                            <a href="#" class="text-green-300 hover:text-green-200 underline">Terms of Service</a> 
                            and 
                            <a href="#" class="text-green-300 hover:text-green-200 underline">Privacy Policy</a>
                        </span>
                    </label>
                </div>
